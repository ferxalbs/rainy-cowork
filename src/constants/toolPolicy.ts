...
const TOOL_POLICY_MAP: Record<string, ToolPolicy> = {
  ...
  ingest_document: { skill: "filesystem", airlockLevel: AirlockLevels.Safe },
  ...
  git_show: { skill: "shell", airlockLevel: AirlockLevels.Safe },
  git_branch_list: { skill: "shell", airlockLevel: AirlockLevels.Safe },
  ...
  http_get_text: { skill: "web", airlockLevel: AirlockLevels.Safe },
