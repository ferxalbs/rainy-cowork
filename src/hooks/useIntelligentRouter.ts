...
interface UseIntelligentRouterResult {
    ...
    // Completions
    completeWithRouting: (request: RoutedChatRequest) => Promise<ChatCompletionResponse>;
    streamWithRouting: (
        request: RoutedChatRequest,
        onEvent: (event: StreamingEvent) => void
    ) => Promise<void>;
    embedWithRouting: (request: RoutedEmbeddingRequest) => Promise<EmbeddingResponse>;
...
export function useIntelligentRouter(): UseIntelligentRouterResult {
    ...
    const updateConfig = useCallback(async (
        newConfig: Partial<RouterConfigDto>
    ...
    const completeWithRouting = useCallback(async (
        request: RoutedChatRequest
    ...
    const embedWithRouting = useCallback(async (
