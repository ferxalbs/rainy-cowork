...
// Helper component for Copy functionality defined early so it can be used in components object
...
// Extracted plugins to avoid referential inequality causing complete AST re-parsing on every re-render
const REMARK_PLUGINS = [remarkGfm];
const REHYPE_PLUGINS = [rehypeSanitize, rehypeHighlight];

// Extracted components to avoid referential inequality
