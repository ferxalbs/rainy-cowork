...
// ⚡ Bolt: Define plugins and components statically outside the functional
// component to ensure referential equality, avoiding complete AST teardown
// and re-parsing on every render.
...
// ⚡ Bolt: Wrap with React.memo to prevent unnecessary re-rendering
// when the parent re-renders due to active streaming updates.
