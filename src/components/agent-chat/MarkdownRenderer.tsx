...
// Optimization: Extract components object to prevent recreation on every render
...
// Optimization: Memoize the component to prevent re-renders when content is unchanged
