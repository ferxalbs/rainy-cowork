...
// ⚡ Bolt: Extract plugins and components outside of the functional component
// to maintain referential equality and prevent expensive AST re-parsing on every re-render.
...
// ⚡ Bolt: Wrap the renderer in React.memo to prevent unnecessary re-renders
// when parent components (e.g., streaming chat interfaces) update state.
