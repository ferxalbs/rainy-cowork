...
function MessageBubbleComponent({
  ...
  const handleRetryRun = React.useCallback(() => onRetryRun?.(message.id), [onRetryRun, message.id]);
  const handleStopRun = React.useCallback(() => onStopRun?.(message.id), [onStopRun, message.id]);
