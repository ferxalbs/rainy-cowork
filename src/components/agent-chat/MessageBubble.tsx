...
// ⚡ Bolt Perf Optimization: Extracted stable EMPTY_ARRAY reference to prevent referential equality checks from failing during re-renders
...
function MessageBubbleComponent({
  ...
  // ⚡ Bolt Perf Optimization: Memoized callback to prevent child components from re-rendering
...
// ⚡ Bolt Perf Optimization: Wrapped in React.memo to prevent unnecessary re-renders
