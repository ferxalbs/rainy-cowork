...
// ⚡ Bolt: Stable reference for fallback props to prevent unnecessary re-renders in memoized children during streaming updates
...
function MessageBubbleComponent({
  ...
  // ⚡ Bolt: Memoize callback to prevent prop regeneration on every token during streaming
